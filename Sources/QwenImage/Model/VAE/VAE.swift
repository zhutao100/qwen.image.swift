...
public final class QwenVAE: Module {
  private static let latentsMeanValues: [Float] = [
  ...
  private static let latentsStdValues: [Float] = [
  ...
  static var latentsMean: MLXArray {
    MLXArray(latentsMeanValues, [1, 16, 1, 1, 1])
  }

  static var latentsStd: MLXArray {
    MLXArray(latentsStdValues, [1, 16, 1, 1, 1])
  }
